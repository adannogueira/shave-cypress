...
let SendForgotPasswordEmailSercice = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  constructor(usersRepository, mailShaver, userTokensRepository) {
    this.usersRepository = usersRepository;
    this.mailShaver = mailShaver;
  ...
  async execute({
    ...
    await this.mailShaver.sendMail({
      to: {
        name: user.name,
        email: user.email
      },
      subject: '[Shave eXperencie] Recuperação de senha',
      templateData: {
